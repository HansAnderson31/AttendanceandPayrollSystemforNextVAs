        ...
        <div class="row">
            ...
            <div class="row2" style="font-size: 5pt">
                ...
                <div class="input_row">
                    ...
                    <div class="cell">
                        <div>
                            <asp:Label ID="Label7" CssClass="labelInput" runat="server" Text="Birth Place"></asp:Label>
                        </div>
                        <div>
                            <asp:TextBox ID="birthPlace_Textbox" CssClass="textBoxInput" runat="server"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="input_row">
                    <div class="cell">
                        <div>
                            <asp:Label ID="Label8" CssClass="labelInput" runat="server" Text="Status"></asp:Label>
                        </div>
                        <div>
                            <asp:TextBox ID="status_Textbox" CssClass="textBoxInput" runat="server"></asp:TextBox>
                        </div>
                    </div>
                    <div class="cell">
                        <div>
                            <asp:Label ID="Label9" CssClass="labelInput" runat="server" Text="Nationality"></asp:Label>
                        </div>
                        <div>
                            <asp:TextBox ID="nationality_Textbox" CssClass="textBoxInput" runat="server"></asp:TextBox>
                        </div>
                    </div>
                    <div class="cell">
                        <div>
                            <asp:Label ID="Label10" CssClass="labelInput" runat="server" Text="Religion"></asp:Label>
                        </div>
                        <div>
                            <asp:TextBox ID="religion_Textbox" CssClass="textBoxInput" runat="server"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="home_add">
                    ...
                    <div>
                        <asp:TextBox ID="home_add_Textbox" runat="server" style="width:530px; font-size:8pt;"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="input_row">
                    ...
                    <div class="cell">
                        <div>
                            <asp:Label ID="Label13" CssClass="labelInput" runat="server" Text="Telephone Number"></asp:Label>
                        </div>
                        <div>
                            <asp:TextBox ID="tel_num_Textbox" CssClass="textBoxInput" runat="server"></asp:TextBox>
                        </div>
                    </div>
                </div>
            ...
            <div class="row2_extend">
                <div class="job_sched">
                    <div class="input_row">
                        ...
                        <div class="cell" id="password_area" runat="server">
                            <div>
                                <asp:Label CssClass="label_sched" ID="Label18" runat="server" Text="Password"></asp:Label>
                            </div>
                            <div>
                                <asp:TextBox CssClass="input_sched" ID="password_TextBox" runat="server" TextMode="Password"></asp:TextBox>
                            </div>
                        </div>
                    </div>
